    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="max-w-md w-full bg-white shadow-lg p-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-light mb-2" style={{ fontFamily: 'Montserrat, sans-serif' }}>Admin Login</h1>
          <p className="text-gray-600" style={{ fontFamily: 'Montserrat, sans-serif' }}>Sayanton Sadhu Photography</p>
        </div>
